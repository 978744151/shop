        ...
        for (var index = 0; index < my.max; index++)
        {
            ...
            if (my.imageScaling)
            {
                ...
                else
                {
                    try
                    {
                        var z = (Math.sqrt(1000 + x * x) + 100) * my.imagesM;
                        ...
                        image.style.left = xs - (image.pc / 2) / z * my.size * oversize + 'px';
                        if (newImageW && newImageH)
                        {
                            //image.style.height = newImageH*oversize + 'px';
                            image.style.width = newImageW + 25 + 'px';
                            image.style.top =  newImageTop / oversize - newImageTop/3 - 25  + 'px';
                        }
